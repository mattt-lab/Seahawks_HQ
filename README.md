...
facts, never for picking what matters.
...
- **Gameday** — next opponent, kickoff time and venue, the betting line, both teams' injury
  ...
  Once a game starts: live score; once it ends: an instant deterministic recap, replaced by a
  fuller AI-written one on the next pipeline run.
